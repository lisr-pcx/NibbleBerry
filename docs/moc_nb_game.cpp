...
Q_CONSTINIT static const qt_meta_stringdata_CLASSNB_GameENDCLASS_t qt_meta_stringdata_CLASSNB_GameENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 14),  // "ForceUpdateGUI"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 5),  // "index"
        QT_MOC_LITERAL(30, 14)   // "UpdateBoxColor"
    },
    "NB_Game",
    "ForceUpdateGUI",
    "",
...
void NB_Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ForceUpdateGUI((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1]))); break;
        case 1: _t->UpdateBoxColor((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1]))); break;
        default: ;
        }
    }
}
